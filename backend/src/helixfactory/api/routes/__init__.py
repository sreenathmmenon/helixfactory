...
from helixfactory.api.routes import ai, audit, blast_radius, executions, graph, mcp, qa, repositories, safety_reviews, skill_refinements
...
def build_router() -> APIRouter:
    ...
    router.include_router(safety_reviews.router)
